...
public class ListerrecController implements Initializable {
   ...
   private TableColumn idd;
    ...
    @FXML
     void converttoexcel(ActionEvent event)throws ClassNotFoundException, SQLException,FileNotFoundException,  IOException {
      ...
      .executeQuery("SELECT r.idRec,r.Note,r.description,e.intitule FROM recommandation r , evenement e where r.id_event= e.id_event");
 ...
 cell.setCellValue("description");
   cell=row.createCell(3);
     ...
     cell=row.createCell(4);
         cell.setCellValue(resultSet.getString("intitule"));
         i++;
      }
